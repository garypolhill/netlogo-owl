 ...
 * <!-- Imports -->
 * 
 * Command to assert that the structure ontology imports others
 * 
 * @author Gary Polhill
 */
public class Imports extends DefaultCommand implements Primitive {
  ...
  public void perform(Argument[] args, Context context) throws ExtensionException, LogoException {
    ...
    if(extension.getModelIRI() != null) {
      throw new ExtensionException("You must declare owl:imports before declaring the owl:model IRI");
    }
    
    for(Argument arg: args) {
      String iriStr = arg.getString();
      IRI iri = IRI.create(iriStr);
      extension.addImport(iri);
    }
  }
